...
runUCommands sub (Va x)            = undefined
runUCommands sub (Co Abort)        = undefined
runUCommands sub (Co (Get v k))    = undefined  -- should look up v
runUCommands sub (Co (Set v t k))  = undefined  -- should continue with a modified substitution
...
(->>) :: Tr TyF String -> Tr TyF String -> Tr TyF String
s ->> t = Co (R (I s :&: I t))
